...
const LeftSide = () => {
  return (
    <div className=" w-full h-[40vh] flex-col flex lg:w-1/2 lg:h-[55%] border-2 border-white lg:items-end lg:pr-12  ">
      <h1 className=" text-4xl font-bold">
        Send plata <br /> between amigos, <br /> quick & easy
      </h1>
      <p className=" w-full lg:w-6/12 text-[12px] mt-5 ">
      ...
      <span className=" w-full flex lg:flex-row flex-col lg:w-1/2 gap-4 mt-8">
