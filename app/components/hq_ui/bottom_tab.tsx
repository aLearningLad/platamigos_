  ...
  return (
    <div className=" h-full w-full bg-white rounded-xl flex flex-col p-2 justify-around ">
      <span className=" w-full hidden lg:flex justify-between items-center h-[15%]">
        <p className=" italic text-[12px] font-semibold">plata.migos</p>
        <div className=" w-fit flex gap-2 items-center justify-end">
          <p className=" w-fit px-3 rounded-lg bg-purple-600/20 text-purple-700 text-[10px] py-1 ">
            finance
          </p>
          <p className=" w-fit px-3 rounded-lg bg-orange-600/20 text-orange-700 text-[10px] py-1 ">
            credit
          </p>
        </div>
      </span>
      <div className=" w-full text-start lg:block hidden overscroll-auto">
        <p className=" text-[12px] text-neutral-600 w-8/12">
          This project is written in Typescript. It uses Zustand, Redis, &
          PostgreSQL. Keen to dive into {"it's"} repo?
      ...
      <div className=" w-full gap-6 flex mt-1 lg:flex-row flex-col lg:justify-start items-center px-1 lg:px-0">
        <Link
        ...
        >
          ...
          />
          <p className=" text-[18px] lg:text-[10px] text-neutral-700 group-hover:text-white ">
            See The Code
          </p>
        </Link>
        <Link
