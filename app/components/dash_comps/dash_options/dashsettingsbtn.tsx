...
const DashSettingsBtn = () => {
  return (
    ...
    >
      ...
      <p className=" text-[18px] font-semibold group-hover:text-white text-center ">
        Source Code
      </p>
      <p className=" text-[12px] group-hover:text-white text-center">
        Explore repository
      </p>
      <button className=" w-full group-hover:bg-pink-500 group-hover:text-black h-16 lg:h-10 text-[14px] lg:text-[12px] cursor-pointer hover:bg-cyan-500 hover:text-white transition duration-300 ease-in-out bg-neutral-500/10 rounded-[4px] font-semibold ">
        Open Github
      </button>
    </Link>
  );
