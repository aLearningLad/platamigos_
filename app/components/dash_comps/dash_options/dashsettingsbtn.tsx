...
const DashSettingsBtn = () => {
  return (
    <Link
      ...
      target="_blank"
      key={3728}
      className=" w-full space-y-1 group hover:bg-black hover:border-none hover:scale-95 transition duration-300 ease-in lg:w-[30%] min-h-[45%] rounded-lg border-2 border-neutral-400/20 p-3 flex flex-col items-start justify-around"
    >
      ...
      <p className=" text-[14px] group-hover:text-white text-center">
        Explore repository
      </p>
