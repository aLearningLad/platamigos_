...
const FundALoan = () => {
  ...
  return (
    <div className=" py-2 lg:py-5 w-full min-h-screen flex flex-col items-center sm:px-2 md:px-5 lg:px-32 p-3 bg-gradient-to-br from-pink-400/10 via-cyan-500/10 to-orange-600/30">
      ...
      <p className=" text-lg lg:text-[14px] text-neutral-700 mb-5 text-center">
        Fund a loan, earn interest and help an <i>amigo</i>
      </p>
      ...
      {is_loading ? (
        ...
        <div className=" bg-neutral-400/10 flex overflow-auto flex-wrap justify-center rounded-xl items-center w-full h-[80vh] lg:h-[75vh] ">
          {comm_loans.map(
            (
